...
export function renderTwoSeerExecutionInstruction({ seerNames = [] } = {}) {
...
export function renderWolfBlackResultCrisisInstruction({ accuserNames = [] } = {}) {
...
export function renderWhiteWolfDayStrategyInstruction({ voteRequired = false } = {}) {
  return `## 白狼としての今回の判断
...
export function renderCounterClaimOpportunityInstruction(opportunity) {
