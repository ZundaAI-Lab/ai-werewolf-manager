...
(function registerDesktopAutomationConfig(global) {
  'use strict';

  function createDesktopAutomationConfig({
    localLlmConfig,
    providerDefaults,
    settingsSchema,
    getController,
  ...
  global.AiWerewolfDesktopAutomationConfig = Object.freeze({ createDesktopAutomationConfig });
})(window);
