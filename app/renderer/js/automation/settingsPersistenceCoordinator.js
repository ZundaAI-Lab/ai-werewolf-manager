...
(function initializeAiWerewolfSettingsPersistenceCoordinator(globalScope) {
  'use strict';

  const AUTOSAVE_DEBOUNCE_MS = 750;
  const AUTOSAVE_MAX_WAIT_MS = 2000;

  function createSettingsPersistenceCoordinator(context) {
    const {
      bridge,
      controller,
      currentGameState,
  ...
  globalScope.AiWerewolfSettingsPersistenceCoordinator = Object.freeze({ createSettingsPersistenceCoordinator });
